   ...
   <fwb-modal persistent size="md">
      <template #body>
         <form>
            ...
            <button type="submit"
               class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-400 dark:hover:bg-blue-500 dark:focus:ring-blue-600 cursor-pointer">Login</button>
            <p class="text-sm text-center mt-4">
               Don't have account?
               <span class="text-blue-500 hover:underline cursor-pointer">Sign up</span>
            </p>
            ...
            <button type="button"
               class="w-full text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center dark:hover:bg-gray-700 dark:focus:ring-gray-600 dark:bg-gray-600 dark:text-white dark:border-gray-600">

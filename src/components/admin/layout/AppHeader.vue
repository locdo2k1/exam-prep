<template>
  <header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-9000 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
...
import SearchBar from '@/components/admin/layout/header/SearchBar.vue'
import HeaderLogo from '@/components/admin/layout/header/HeaderLogo.vue'
import NotificationMenu from '@/components/admin/layout/header/NotificationMenu.vue'
import UserMenu from '@/components/admin/layout/header/UserMenu.vue'

      ...
      <div v-else class="study-wrapper">
         ...
         <div class="study-content">
            <div v-if="set.cards.length > 0" class="card-container">
               <div class="flashcard" :class="{ flipped: currentCard?.isFlipped }" @click="toggleFlip">
               ...
               <div class="card-actions">
                  <button @click="markMastered" :class="{ active: currentCard?.mastered }"
               ...
               <div class="navigation">
                  <button @click="previousCard" :disabled="currentIndex === 0" class="btn-nav">
                     ← Previous
                  </button>
                  <button @click="nextCard" :disabled="currentIndex === set.cards.length - 1" class="btn-nav">
                     Next →
                  </button>
               </div>
